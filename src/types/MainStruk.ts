...
export type DataType = 'String' | 'Number' | 'Date' | 'Time' | 'Currency' | 'Hidden' | 'random_text' | 'random_number' | 'random_mixed' | 'Admin_Fee' | 'Store_Name' | 'total_keseluruhan' | 'Nominal' | 'Referensi';
